...
![img](http://cc.cocimg.com/api/uploads/20170710/1499657090104458.gif)
...
> 加入现在有三张图片分别为animate*1、animate*2、animate_3方法一
...
> 方法二解释下，这个方法会加载animate*为前缀的，后边0-1024，也就是animate*0、animate*1一直到animate*1024
...
> 圆角和边框看下图即可设置![img](http://cc.cocimg.com/api/uploads/20170710/1499658702959959.png)
>
...
>
> ![img](http://cc.cocimg.com/api/uploads/20170710/1499658718937739.png)
...
![img](http://cc.cocimg.com/api/uploads/20170710/1499658806305115.png)
...
> UIView有个属性叫做exclusiveTouch，设置为YES后，其响应事件会和其他view互斥(有其他view事件响应的时候点击它不起作用)view.exclusiveTouch = YES;
>
> 一个一个设置太麻烦了，可以全局设置
